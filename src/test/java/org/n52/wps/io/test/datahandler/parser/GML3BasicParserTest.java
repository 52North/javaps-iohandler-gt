...
public class GML3BasicParserTest extends AbstractTestCase {
    ...
    @Inject
    private GML3BasicParser dataHandler;
    ...
    public void testParser() {
        ...
        try {
            theBinding = (GTVectorDataBinding) dataHandler.parse(null, input, new Format("text/xml; subtype=gml/3.1.1", StandardCharsets.UTF_8,
