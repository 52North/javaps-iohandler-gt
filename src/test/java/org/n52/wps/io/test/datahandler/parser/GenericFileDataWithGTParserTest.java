...
public class GenericFileDataWithGTParserTest extends AbstractTestCase {

    @Inject
    private GenericFileDataWithGTParser dataHandler;

    @Test
    public void testParser() {

        InputStream input = getResource("testfile");

        GenericFileDataWithGTBinding theBinding = null;
        try {
            theBinding = (GenericFileDataWithGTBinding) dataHandler.parse(null, input, new Format("text/plain"));
