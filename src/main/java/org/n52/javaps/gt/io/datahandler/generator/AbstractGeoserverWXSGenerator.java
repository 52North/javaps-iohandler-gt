...
public abstract class AbstractGeoserverWXSGenerator extends AbstractPropertiesInputOutputHandler implements
    ...
    public AbstractGeoserverWXSGenerator() {
        ...
        JsonNode propertyNode = getProperties();

        if (propertyNode != null) {
            username = getProperties().get("Geoserver_username").asText();
            password = getProperties().get("Geoserver_password").asText();
            host = getProperties().get("Geoserver_host").asText();
            port = getProperties().get("Geoserver_port").asText();
        }
